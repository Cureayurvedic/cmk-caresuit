...
> = {
  providers: {
    ...
    description:
      "Manage doctor names and source categories displayed in the quick referral provider dropdown.",
  ...
  leadSources: {
    title: "Lead Sources",
    description:
      "Manage patient lead sources for marketing and analytics tracking.",
  ...
  religions: {
    ...
    description:
      "Manage religion categories available in demographics dropdown.",
  ...
  companies: {
    ...
    description:
      "Manage Corporate/Company list for corporate payers configuration.",
  ...
  insurances: {
    ...
    description:
      "Manage Health Insurance companies for insurance payer configuration.",
  ...
  doctors: {
    ...
    description:
      "Manage doctors available in the consultation and billing dropdowns.",
...
export default function SettingsPage() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast.success(
        "Option Removed",
        `"${itemToDelete.value}" has been deleted.`,
      );
      if (activeTab === "branches") {
        window.dispatchEvent(new CustomEvent("cmk:branches-updated"));
      }
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium mt-0.5">
              Configure CMK CareSuite master values, dropdown list options, and
              system parameters
            </p>
          </div>
        </div>
                    ...
                    <form onSubmit={handleAdd} className="p-5 space-y-4">
                      ...
                      <div className="pt-4 flex justify-end gap-2 border-t border-slate-100 mt-2">
                        ...
                        <Button
                          ...
                          className="h-9 text-xs gap-1.5 bg-blue-600 hover:bg-blue-700 cursor-pointer text-white"
                        >
                          {adding ? (
                            <Loader2 className="h-4 w-4 animate-spin" />
                          ) : (
